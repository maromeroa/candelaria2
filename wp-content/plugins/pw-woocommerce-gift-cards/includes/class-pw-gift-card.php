...
class PW_Gift_Card {
    ...
    public static function create_card( $note = '' ) {
        ...
        if ( $gift_card instanceof self ) {
            ...
            wp_die( sprintf( __( 'Failed to generate a unique random card number after %d attempts. %s', 'pw-woocommerce-gift-cards' ), $attempts, $gift_card ) );
        }
    }
