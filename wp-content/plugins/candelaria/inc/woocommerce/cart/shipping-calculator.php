...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	?>
	<?php printf( '<a href="#" class="shipping-calculator-button">Elige tu comuna</a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	<?php 
	endif;
	?>
	<section class="shipping-calculator-form" style="display:none;">

    <?php if (apply_filters( 'woocommerce_shipping_calculator_enable_candelaria', true ) ) : ?>
		<?php do_action('woocommerce_candelaria_form')?>
		<?php endif; ?>
